...
class CustomerDataInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		List.of(//
				new RegistrationForm("hans", password, "wurst", "wurstbude@pelle.de"),
				new RegistrationForm("dextermorgan", password, "Miami-Dade County","whatever@free.com"),
				new RegistrationForm("earlhickey", password, "Camden County - Motel","noreply@request.fr"),
				new RegistrationForm("mclovinfogell", password, "Los Angeles","usa@sucks.porn")//
